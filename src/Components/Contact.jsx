    ...
    <>
      {/* <section className="section-wrapper-8 content-inner-1">
        <div className="container">
          <div className="inner-section-wrapper row align-items-center">
          ...
          <div className="container text-center">
            ...
            <form className="form2" action="#" method="post" id="contact_form">
              <div className="name">
